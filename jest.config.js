module.exports = {
  moduleNameMapper: {
    '@app-data': '<rootDir>/runtime/app-data/index.cjs',
    '@app-globals': '<rootDir>/runtime/app-globals/index.cjs',
    '@platform': '<rootDir>/runtime/testing/index.js',
    '@runtime': '<rootDir>/runtime/testing/index.js',
    ...
    '^@stencil/core/runtime/app-data$': '<rootDir>/runtime/app-data/index.cjs',
    '^@stencil/core/runtime/testing$': '<rootDir>/runtime/testing/index.js',
  },
