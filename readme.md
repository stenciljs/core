...
Please take a moment to read up on our guidelines for [contributing](https://github.com/stenciljs/core/blob/main/CONTRIBUTING.md). Each package's source is documented with short `readme.md` files next to the code they describe (e.g. [`packages/core/src/compiler/readme.md`](/packages/core/src/compiler/readme.md), [`packages/core/src/runtime/readme.md`](/packages/core/src/runtime/readme.md)) - browse a package's `src/` directory to find them.
