...
describe('slot-html', () => {
  it('renders', async () => {
    ...
    const results4SlotStartChildren = document.querySelectorAll(
      '.results4 div article span content-start',
    );
    ...
    expect(document.querySelector('.results4 div content-default')!.textContent).toBe(
      'default slot',
    );

    const results5SlotStartChildren = document.querySelectorAll(
      '.results5 div article span content-start',
    );
    ...
    const results6SlotStartChildren = document.querySelectorAll(
      '.results6 div article span content-start',
    );
    ...
    const results7SlotStartChildren = document.querySelectorAll(
      '.results7 div article span content-start',
    );
