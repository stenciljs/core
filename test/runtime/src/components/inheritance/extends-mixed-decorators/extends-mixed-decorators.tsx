 ...
 * - Base has @Prop, component has @State for same property
 * - Base has @State, component has @Prop for same property
 * - Verifies that component decorators override base decorators
 */
@Component({
  tag: 'extends-mixed-decorators',
})
export class ExtendsMixedDecorators extends MixedDecoratorsBase {
