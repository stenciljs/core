...
describe('extends-cmp', () => {
  describe('component classes extending other component classes', () => {
    it('renders default values', async () => {
      const { root } = await render(<extends-cmp-cmp />);

      // Main component values
    ...
    it('re-renders values via attributes', async () => {
      const { root, waitForChanges } = await render(<extends-cmp-cmp />);
