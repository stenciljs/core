...
declare namespace LocalJSX {
    ...
    interface AttributeBasicAttributes {
        ...
        "multiWord": string | number | boolean;
        "customAttr": string | number | boolean;
        "getter": string | number | boolean;
    }
    interface AttributeBooleanAttributes {
        "boolState": string | number | boolean;
        "strState": string | number | boolean;
        "noreflect": string | number | boolean;
    }
    interface AttributeComplexAttributes {
        "nu0": string | number | boolean;
        "nu1": string | number | boolean;
        "nu2": string | number | boolean;
        "bool0": string | number | boolean;
        "bool1": string | number | boolean;
        "bool2": string | number | boolean;
        "str0": string | number | boolean;
        "str1": string | number | boolean;
        "str2": string | number | boolean;
    ...
    interface AttributeDeserializerAttributes {
        ...
        "getSet": string | number | boolean;
    }
    interface AttributeHtmlRootAttributes {
        "strAttr": string | number | boolean;
        "anyAttr": string | number | boolean;
        "nuAttr": string | number | boolean;
    }
    ...
    interface CmpDAttributes {
        "uniqueId": string | number | boolean;
    }
    interface ComplexPropertiesAttributes {
        "grault": string | number | boolean;
        "kidsNames": string | number | boolean;
    }
    interface ComputedPropertiesPropDecoratorAttributes {
        "first": string | number | boolean;
        "middle": string | number | boolean;
    ...
    interface DomReattachAttributes {
        "willLoad": string | number | boolean;
        "didLoad": string | number | boolean;
        "didUnload": string | number | boolean;
    }
    interface EsmImportAttributes {
        "propVal": string | number | boolean;
    }
    ...
    interface ExtendsConflictsAttributes {
        "baseOnlyProp": string | number | boolean;
        "duplicateProp": string | number | boolean;
    }
    ...
    interface ExtendsMixedDecoratorsAttributes {
        "mixedName": string | number | boolean;
        "baseOnlyProp": string | number | boolean;
        "mixedStateName": string | number | boolean;
    }
    ...
    interface ExtendsPropsStateAttributes {
        "baseProp": string | number | boolean;
        "baseCount": string | number | boolean;
        "componentProp": string | number | boolean;
    }
    interface ExtendsWatchAttributes {
        "baseProp": string | number | boolean;
        "baseCount": string | number | boolean;
        "overrideProp": string | number | boolean;
        "childProp": string | number | boolean;
    }
    ...
    interface IonRadioGroupAttributes {
        "allowEmptySelection": string | number | boolean;
        "compareWith": string | number | boolean;
        "name": string | number | boolean;
        "value": string | number | boolean;
        "helperText": string | number | boolean;
        "errorText": string | number | boolean;
    }
    ...
    interface PageListAttributes {
        "lastPage": string | number | boolean;
    }
    ...
    interface PrefixAttrNestedAttributes {
        ...
        "undefinedValue": string | number | boolean;
    }
    ...
    interface PropSerializerAttributes {
        "boolOrSomething": string | number | boolean;
        "nonReflect": string | number | boolean;
        "array": string | number | boolean;
        "json": string | number | boolean;
        "getSet": string | number | boolean;
    }
    ...
    interface ReflectNanAttributeHyphenAttributes {
        "valNum": string | number | boolean;
    }
    interface ReflectToAttrAttributes {
        "str": string | number | boolean;
        "nu": string | number | boolean;
        "undef": string | number | boolean;
        "null": string | number | boolean;
        "bool": string | number | boolean;
        "otherBool": string | number | boolean;
        "disabled": string | number | boolean;
        "dynamicStr": string | number | boolean;
        "dynamicNu": string | number | boolean;
    }
    interface ScopedConditionalAttributes {
        "renderHello": string | number | boolean;
    }
    interface ScopedSlotContentHideAttributes {
        "useSlot": string | number | boolean;
    }
    interface ScopedSlotSlotchangeWrapAttributes {
        "swapSlotContent": string | number | boolean;
    }
    ...
    interface SlotDynamicNameChangeScopedAttributes {
        "slotName": string | number | boolean;
    }
    ...
    interface SlotReorderAttributes {
        "reordered": string | number | boolean;
    }
    ...
    interface TsTargetPropsAttributes {
        "basicProp": string | number | boolean;
        "decoratedProp": string | number | boolean;
        "decoratedGetterSetterProp": string | number | boolean;
    }
    ...
    interface IntrinsicElements {
        ...
        "attribute-basic": AttributeBasic & { [K in keyof AttributeBasic & keyof AttributeBasicAttributes as `attr:${K}`]?: AttributeBasicAttributes[K] } & { [K in keyof AttributeBasic & keyof AttributeBasicAttributes as `prop:${K}`]?: AttributeBasic[K] };
        "attribute-basic-root": AttributeBasicRoot;
        "attribute-boolean": AttributeBoolean & { [K in keyof AttributeBoolean & keyof AttributeBooleanAttributes as `attr:${K}`]?: AttributeBooleanAttributes[K] } & { [K in keyof AttributeBoolean & keyof AttributeBooleanAttributes as `prop:${K}`]?: AttributeBoolean[K] };
        "attribute-boolean-root": AttributeBooleanRoot;
        "attribute-complex": AttributeComplex & { [K in keyof AttributeComplex & keyof AttributeComplexAttributes as `attr:${K}`]?: AttributeComplexAttributes[K] } & { [K in keyof AttributeComplex & keyof AttributeComplexAttributes as `prop:${K}`]?: AttributeComplex[K] };
        "attribute-deserializer": AttributeDeserializer & { [K in keyof AttributeDeserializer & keyof AttributeDeserializerAttributes as `attr:${K}`]?: AttributeDeserializerAttributes[K] } & { [K in keyof AttributeDeserializer & keyof AttributeDeserializerAttributes as `prop:${K}`]?: AttributeDeserializer[K] };
        "attribute-host": AttributeHost;
        "attribute-html-root": AttributeHtmlRoot & { [K in keyof AttributeHtmlRoot & keyof AttributeHtmlRootAttributes as `attr:${K}`]?: AttributeHtmlRootAttributes[K] } & { [K in keyof AttributeHtmlRoot & keyof AttributeHtmlRootAttributes as `prop:${K}`]?: AttributeHtmlRoot[K] };
        "bad-shared-jsx": BadSharedJsx;
        "build-data": BuildData;
        "child-reflect-nan-attribute": ChildReflectNanAttribute & { [K in keyof ChildReflectNanAttribute & keyof ChildReflectNanAttributeAttributes as `attr:${K}`]?: ChildReflectNanAttributeAttributes[K] } & { [K in keyof ChildReflectNanAttribute & keyof ChildReflectNanAttributeAttributes as `prop:${K}`]?: ChildReflectNanAttribute[K] };
        "child-tag-transform": ChildTagTransform & { [K in keyof ChildTagTransform & keyof ChildTagTransformAttributes as `attr:${K}`]?: ChildTagTransformAttributes[K] } & { [K in keyof ChildTagTransform & keyof ChildTagTransformAttributes as `prop:${K}`]?: ChildTagTransform[K] };
        "child-with-reflection": ChildWithReflection & { [K in keyof ChildWithReflection & keyof ChildWithReflectionAttributes as `attr:${K}`]?: ChildWithReflectionAttributes[K] } & { [K in keyof ChildWithReflection & keyof ChildWithReflectionAttributes as `prop:${K}`]?: ChildWithReflection[K] };
        ...
        "cmp-d": CmpD & { [K in keyof CmpD & keyof CmpDAttributes as `attr:${K}`]?: CmpDAttributes[K] } & { [K in keyof CmpD & keyof CmpDAttributes as `prop:${K}`]?: CmpD[K] };
        "cmp-label": CmpLabel;
        ...
        "complex-properties": ComplexProperties & { [K in keyof ComplexProperties & keyof ComplexPropertiesAttributes as `attr:${K}`]?: ComplexPropertiesAttributes[K] } & { [K in keyof ComplexProperties & keyof ComplexPropertiesAttributes as `prop:${K}`]?: ComplexProperties[K] };
        ...
        "computed-properties-prop-decorator": ComputedPropertiesPropDecorator & { [K in keyof ComputedPropertiesPropDecorator & keyof ComputedPropertiesPropDecoratorAttributes as `attr:${K}`]?: ComputedPropertiesPropDecoratorAttributes[K] } & { [K in keyof ComputedPropertiesPropDecorator & keyof ComputedPropertiesPropDecoratorAttributes as `prop:${K}`]?: ComputedPropertiesPropDecorator[K] };
        "computed-properties-prop-decorator-reflect": ComputedPropertiesPropDecoratorReflect & { [K in keyof ComputedPropertiesPropDecoratorReflect & keyof ComputedPropertiesPropDecoratorReflectAttributes as `attr:${K}`]?: ComputedPropertiesPropDecoratorReflectAttributes[K] } & { [K in keyof ComputedPropertiesPropDecoratorReflect & keyof ComputedPropertiesPropDecoratorReflectAttributes as `prop:${K}`]?: ComputedPropertiesPropDecoratorReflect[K] };
        "computed-properties-state-decorator": ComputedPropertiesStateDecorator;
        "computed-properties-watch-decorator": ComputedPropertiesWatchDecorator & { [K in keyof ComputedPropertiesWatchDecorator & keyof ComputedPropertiesWatchDecoratorAttributes as `attr:${K}`]?: ComputedPropertiesWatchDecoratorAttributes[K] } & { [K in keyof ComputedPropertiesWatchDecorator & keyof ComputedPropertiesWatchDecoratorAttributes as `prop:${K}`]?: ComputedPropertiesWatchDecorator[K] };
        ...
        "dom-reattach": DomReattach & { [K in keyof DomReattach & keyof DomReattachAttributes as `attr:${K}`]?: DomReattachAttributes[K] } & { [K in keyof DomReattach & keyof DomReattachAttributes as `prop:${K}`]?: DomReattach[K] };
        ...
        "esm-import": EsmImport & { [K in keyof EsmImport & keyof EsmImportAttributes as `attr:${K}`]?: EsmImportAttributes[K] } & { [K in keyof EsmImport & keyof EsmImportAttributes as `prop:${K}`]?: EsmImport[K] };
        ...
        "extended-cmp": ExtendedCmp & { [K in keyof ExtendedCmp & keyof ExtendedCmpAttributes as `attr:${K}`]?: ExtendedCmpAttributes[K] } & { [K in keyof ExtendedCmp & keyof ExtendedCmpAttributes as `prop:${K}`]?: ExtendedCmp[K] };
        "extended-cmp-cmp": ExtendedCmpCmp & { [K in keyof ExtendedCmpCmp & keyof ExtendedCmpCmpAttributes as `attr:${K}`]?: ExtendedCmpCmpAttributes[K] } & { [K in keyof ExtendedCmpCmp & keyof ExtendedCmpCmpAttributes as `prop:${K}`]?: ExtendedCmpCmp[K] };
        "extends-abstract": ExtendsAbstract & { [K in keyof ExtendsAbstract & keyof ExtendsAbstractAttributes as `attr:${K}`]?: ExtendsAbstractAttributes[K] } & { [K in keyof ExtendsAbstract & keyof ExtendsAbstractAttributes as `prop:${K}`]?: ExtendsAbstract[K] };
        "extends-cmp-cmp": ExtendsCmpCmp & { [K in keyof ExtendsCmpCmp & keyof ExtendsCmpCmpAttributes as `attr:${K}`]?: ExtendsCmpCmpAttributes[K] } & { [K in keyof ExtendsCmpCmp & keyof ExtendsCmpCmpAttributes as `prop:${K}`]?: ExtendsCmpCmp[K] };
        "extends-conflicts": ExtendsConflicts & { [K in keyof ExtendsConflicts & keyof ExtendsConflictsAttributes as `attr:${K}`]?: ExtendsConflictsAttributes[K] } & { [K in keyof ExtendsConflicts & keyof ExtendsConflictsAttributes as `prop:${K}`]?: ExtendsConflicts[K] };
        "extends-controller-updates": ExtendsControllerUpdates;
        "extends-direct-state": ExtendsDirectState;
        "extends-events": ExtendsEvents;
        "extends-external": ExtendsExternal & { [K in keyof ExtendsExternal & keyof ExtendsExternalAttributes as `attr:${K}`]?: ExtendsExternalAttributes[K] } & { [K in keyof ExtendsExternal & keyof ExtendsExternalAttributes as `prop:${K}`]?: ExtendsExternal[K] };
        "extends-lifecycle-basic": ExtendsLifecycleBasic;
        "extends-lifecycle-multilevel": ExtendsLifecycleMultilevel;
        "extends-local": ExtendsLocal & { [K in keyof ExtendsLocal & keyof ExtendsLocalAttributes as `attr:${K}`]?: ExtendsLocalAttributes[K] } & { [K in keyof ExtendsLocal & keyof ExtendsLocalAttributes as `prop:${K}`]?: ExtendsLocal[K] };
        "extends-methods": ExtendsMethods;
        "extends-mixed-decorators": ExtendsMixedDecorators & { [K in keyof ExtendsMixedDecorators & keyof ExtendsMixedDecoratorsAttributes as `attr:${K}`]?: ExtendsMixedDecoratorsAttributes[K] } & { [K in keyof ExtendsMixedDecorators & keyof ExtendsMixedDecoratorsAttributes as `prop:${K}`]?: ExtendsMixedDecorators[K] };
        "extends-mixin-cmp": ExtendsMixinCmp & { [K in keyof ExtendsMixinCmp & keyof ExtendsMixinCmpAttributes as `attr:${K}`]?: ExtendsMixinCmpAttributes[K] } & { [K in keyof ExtendsMixinCmp & keyof ExtendsMixinCmpAttributes as `prop:${K}`]?: ExtendsMixinCmp[K] };
        "extends-props-state": ExtendsPropsState & { [K in keyof ExtendsPropsState & keyof ExtendsPropsStateAttributes as `attr:${K}`]?: ExtendsPropsStateAttributes[K] } & { [K in keyof ExtendsPropsState & keyof ExtendsPropsStateAttributes as `prop:${K}`]?: ExtendsPropsState[K] };
        "extends-render": ExtendsRender;
        "extends-via-host-cmp": ExtendsViaHostCmp;
        "extends-watch": ExtendsWatch & { [K in keyof ExtendsWatch & keyof ExtendsWatchAttributes as `attr:${K}`]?: ExtendsWatchAttributes[K] } & { [K in keyof ExtendsWatch & keyof ExtendsWatchAttributes as `prop:${K}`]?: ExtendsWatch[K] };
        ...
        "form-associated-prop-check": FormAssociatedPropCheck & { [K in keyof FormAssociatedPropCheck & keyof FormAssociatedPropCheckAttributes as `attr:${K}`]?: FormAssociatedPropCheckAttributes[K] } & { [K in keyof FormAssociatedPropCheck & keyof FormAssociatedPropCheckAttributes as `prop:${K}`]?: FormAssociatedPropCheck[K] };
        "global-styles": GlobalStyles;
        "host-attr-override": HostAttrOverride;
        "image-import": ImageImport;
        "import-aliasing": ImportAliasing & { [K in keyof ImportAliasing & keyof ImportAliasingAttributes as `attr:${K}`]?: ImportAliasingAttributes[K] } & { [K in keyof ImportAliasing & keyof ImportAliasingAttributes as `prop:${K}`]?: ImportAliasing[K] };
        ...
        "input-basic-root": InputBasicRoot & { [K in keyof InputBasicRoot & keyof InputBasicRootAttributes as `attr:${K}`]?: InputBasicRootAttributes[K] } & { [K in keyof InputBasicRoot & keyof InputBasicRootAttributes as `prop:${K}`]?: InputBasicRoot[K] };
        "ion-child": IonChild;
        "ion-host": IonHost;
        "ion-parent": IonParent;
        "ion-radio": IonRadio & { [K in keyof IonRadio & keyof IonRadioAttributes as `attr:${K}`]?: IonRadioAttributes[K] } & { [K in keyof IonRadio & keyof IonRadioAttributes as `prop:${K}`]?: IonRadio[K] };
        "ion-radio-group": IonRadioGroup & { [K in keyof IonRadioGroup & keyof IonRadioGroupAttributes as `attr:${K}`]?: IonRadioGroupAttributes[K] } & { [K in keyof IonRadioGroup & keyof IonRadioGroupAttributes as `prop:${K}`]?: IonRadioGroup[K] };
        "json-basic": JsonBasic;
        "key-reorder": KeyReorder;
        "lifecycle-async-a": LifecycleAsyncA;
        "lifecycle-async-b": LifecycleAsyncB & { [K in keyof LifecycleAsyncB & keyof LifecycleAsyncBAttributes as `attr:${K}`]?: LifecycleAsyncBAttributes[K] } & { [K in keyof LifecycleAsyncB & keyof LifecycleAsyncBAttributes as `prop:${K}`]?: LifecycleAsyncB[K] };
        "lifecycle-async-c": LifecycleAsyncC & { [K in keyof LifecycleAsyncC & keyof LifecycleAsyncCAttributes as `attr:${K}`]?: LifecycleAsyncCAttributes[K] } & { [K in keyof LifecycleAsyncC & keyof LifecycleAsyncCAttributes as `prop:${K}`]?: LifecycleAsyncC[K] };
        "lifecycle-basic-a": LifecycleBasicA;
        "lifecycle-basic-b": LifecycleBasicB & { [K in keyof LifecycleBasicB & keyof LifecycleBasicBAttributes as `attr:${K}`]?: LifecycleBasicBAttributes[K] } & { [K in keyof LifecycleBasicB & keyof LifecycleBasicBAttributes as `prop:${K}`]?: LifecycleBasicB[K] };
        "lifecycle-basic-c": LifecycleBasicC & { [K in keyof LifecycleBasicC & keyof LifecycleBasicCAttributes as `attr:${K}`]?: LifecycleBasicCAttributes[K] } & { [K in keyof LifecycleBasicC & keyof LifecycleBasicCAttributes as `prop:${K}`]?: LifecycleBasicC[K] };
        ...
        "lifecycle-update-b": LifecycleUpdateB & { [K in keyof LifecycleUpdateB & keyof LifecycleUpdateBAttributes as `attr:${K}`]?: LifecycleUpdateBAttributes[K] } & { [K in keyof LifecycleUpdateB & keyof LifecycleUpdateBAttributes as `prop:${K}`]?: LifecycleUpdateB[K] };
        "lifecycle-update-c": LifecycleUpdateC & { [K in keyof LifecycleUpdateC & keyof LifecycleUpdateCAttributes as `attr:${K}`]?: LifecycleUpdateCAttributes[K] } & { [K in keyof LifecycleUpdateC & keyof LifecycleUpdateCAttributes as `prop:${K}`]?: LifecycleUpdateC[K] };
        ...
        "page-list": PageList & { [K in keyof PageList & keyof PageListAttributes as `attr:${K}`]?: PageListAttributes[K] } & { [K in keyof PageList & keyof PageListAttributes as `prop:${K}`]?: PageList[K] };
        "page-list-item": PageListItem & { [K in keyof PageListItem & keyof PageListItemAttributes as `attr:${K}`]?: PageListItemAttributes[K] } & { [K in keyof PageListItem & keyof PageListItemAttributes as `prop:${K}`]?: PageListItem[K] };
        ...
        "part-ssr-shadow-cmp": PartSsrShadowCmp & { [K in keyof PartSsrShadowCmp & keyof PartSsrShadowCmpAttributes as `attr:${K}`]?: PartSsrShadowCmpAttributes[K] } & { [K in keyof PartSsrShadowCmp & keyof PartSsrShadowCmpAttributes as `prop:${K}`]?: PartSsrShadowCmp[K] };
        "part-wrap-ssr-shadow-cmp": PartWrapSsrShadowCmp & { [K in keyof PartWrapSsrShadowCmp & keyof PartWrapSsrShadowCmpAttributes as `attr:${K}`]?: PartWrapSsrShadowCmpAttributes[K] } & { [K in keyof PartWrapSsrShadowCmp & keyof PartWrapSsrShadowCmpAttributes as `prop:${K}`]?: PartWrapSsrShadowCmp[K] };
        "prefix-attr-nested": PrefixAttrNested & { [K in keyof PrefixAttrNested & keyof PrefixAttrNestedAttributes as `attr:${K}`]?: PrefixAttrNestedAttributes[K] } & { [K in keyof PrefixAttrNested & keyof PrefixAttrNestedAttributes as `prop:${K}`]?: PrefixAttrNested[K] };
        "prefix-attr-root": PrefixAttrRoot;
        "prefix-prop-nested": PrefixPropNested & { [K in keyof PrefixPropNested & keyof PrefixPropNestedAttributes as `attr:${K}`]?: PrefixPropNestedAttributes[K] } & { [K in keyof PrefixPropNested & keyof PrefixPropNestedAttributes as `prop:${K}`]?: PrefixPropNested[K] };
        "prefix-prop-root": PrefixPropRoot;
        "prop-serializer": PropSerializer & { [K in keyof PropSerializer & keyof PropSerializerAttributes as `attr:${K}`]?: PropSerializerAttributes[K] } & { [K in keyof PropSerializer & keyof PropSerializerAttributes as `prop:${K}`]?: PropSerializer[K] };
        "radio-group-blur-test": RadioGroupBlurTest;
        "ref-attr-order": RefAttrOrder;
        "reflect-nan-attribute": ReflectNanAttribute & { [K in keyof ReflectNanAttribute & keyof ReflectNanAttributeAttributes as `attr:${K}`]?: ReflectNanAttributeAttributes[K] } & { [K in keyof ReflectNanAttribute & keyof ReflectNanAttributeAttributes as `prop:${K}`]?: ReflectNanAttribute[K] };
        "reflect-nan-attribute-hyphen": ReflectNanAttributeHyphen & { [K in keyof ReflectNanAttributeHyphen & keyof ReflectNanAttributeHyphenAttributes as `attr:${K}`]?: ReflectNanAttributeHyphenAttributes[K] } & { [K in keyof ReflectNanAttributeHyphen & keyof ReflectNanAttributeHyphenAttributes as `prop:${K}`]?: ReflectNanAttributeHyphen[K] };
        "reflect-to-attr": ReflectToAttr & { [K in keyof ReflectToAttr & keyof ReflectToAttrAttributes as `attr:${K}`]?: ReflectToAttrAttributes[K] } & { [K in keyof ReflectToAttr & keyof ReflectToAttrAttributes as `prop:${K}`]?: ReflectToAttr[K] };
        ...
        "scoped-conditional": ScopedConditional & { [K in keyof ScopedConditional & keyof ScopedConditionalAttributes as `attr:${K}`]?: ScopedConditionalAttributes[K] } & { [K in keyof ScopedConditional & keyof ScopedConditionalAttributes as `prop:${K}`]?: ScopedConditional[K] };
        ...
        "scoped-slot-content-hide": ScopedSlotContentHide & { [K in keyof ScopedSlotContentHide & keyof ScopedSlotContentHideAttributes as `attr:${K}`]?: ScopedSlotContentHideAttributes[K] } & { [K in keyof ScopedSlotContentHide & keyof ScopedSlotContentHideAttributes as `prop:${K}`]?: ScopedSlotContentHide[K] };
        ...
        "scoped-slot-slotchange-wrap": ScopedSlotSlotchangeWrap & { [K in keyof ScopedSlotSlotchangeWrap & keyof ScopedSlotSlotchangeWrapAttributes as `attr:${K}`]?: ScopedSlotSlotchangeWrapAttributes[K] } & { [K in keyof ScopedSlotSlotchangeWrap & keyof ScopedSlotSlotchangeWrapAttributes as `prop:${K}`]?: ScopedSlotSlotchangeWrap[K] };
        "scoped-ssr-child-cmp": ScopedSsrChildCmp;
        "scoped-ssr-parent-cmp": ScopedSsrParentCmp;
        "serialize-deserializer": SerializeDeserializer & { [K in keyof SerializeDeserializer & keyof SerializeDeserializerAttributes as `attr:${K}`]?: SerializeDeserializerAttributes[K] } & { [K in keyof SerializeDeserializer & keyof SerializeDeserializerAttributes as `prop:${K}`]?: SerializeDeserializer[K] };
        ...
        "shadow-dom-slot-nested": ShadowDomSlotNested & { [K in keyof ShadowDomSlotNested & keyof ShadowDomSlotNestedAttributes as `attr:${K}`]?: ShadowDomSlotNestedAttributes[K] } & { [K in keyof ShadowDomSlotNested & keyof ShadowDomSlotNestedAttributes as `prop:${K}`]?: ShadowDomSlotNested[K] };
        ...
        "sibling-extended": SiblingExtended & { [K in keyof SiblingExtended & keyof SiblingExtendedAttributes as `attr:${K}`]?: SiblingExtendedAttributes[K] } & { [K in keyof SiblingExtended & keyof SiblingExtendedAttributes as `prop:${K}`]?: SiblingExtended[K] };
        ...
        "slot-dynamic-name-change-scoped": SlotDynamicNameChangeScoped & { [K in keyof SlotDynamicNameChangeScoped & keyof SlotDynamicNameChangeScopedAttributes as `attr:${K}`]?: SlotDynamicNameChangeScopedAttributes[K] } & { [K in keyof SlotDynamicNameChangeScoped & keyof SlotDynamicNameChangeScopedAttributes as `prop:${K}`]?: SlotDynamicNameChangeScoped[K] };
        "slot-dynamic-name-change-shadow": SlotDynamicNameChangeShadow & { [K in keyof SlotDynamicNameChangeShadow & keyof SlotDynamicNameChangeShadowAttributes as `attr:${K}`]?: SlotDynamicNameChangeShadowAttributes[K] } & { [K in keyof SlotDynamicNameChangeShadow & keyof SlotDynamicNameChangeShadowAttributes as `prop:${K}`]?: SlotDynamicNameChangeShadow[K] };
        "slot-dynamic-scoped-list": SlotDynamicScopedList;
        "slot-dynamic-shadow-list": SlotDynamicShadowList;
        "slot-dynamic-wrapper": SlotDynamicWrapper & { [K in keyof SlotDynamicWrapper & keyof SlotDynamicWrapperAttributes as `attr:${K}`]?: SlotDynamicWrapperAttributes[K] } & { [K in keyof SlotDynamicWrapper & keyof SlotDynamicWrapperAttributes as `prop:${K}`]?: SlotDynamicWrapper[K] };
        "slot-dynamic-wrapper-root": SlotDynamicWrapperRoot;
        "slot-fallback": SlotFallback & { [K in keyof SlotFallback & keyof SlotFallbackAttributes as `attr:${K}`]?: SlotFallbackAttributes[K] } & { [K in keyof SlotFallback & keyof SlotFallbackAttributes as `prop:${K}`]?: SlotFallback[K] };
        "slot-fallback-root": SlotFallbackRoot;
        "slot-forward-child-fallback": SlotForwardChildFallback & { [K in keyof SlotForwardChildFallback & keyof SlotForwardChildFallbackAttributes as `attr:${K}`]?: SlotForwardChildFallbackAttributes[K] } & { [K in keyof SlotForwardChildFallback & keyof SlotForwardChildFallbackAttributes as `prop:${K}`]?: SlotForwardChildFallback[K] };
        "slot-forward-root": SlotForwardRoot & { [K in keyof SlotForwardRoot & keyof SlotForwardRootAttributes as `attr:${K}`]?: SlotForwardRootAttributes[K] } & { [K in keyof SlotForwardRoot & keyof SlotForwardRootAttributes as `prop:${K}`]?: SlotForwardRoot[K] };
        "slot-hide-content-open": SlotHideContentOpen & { [K in keyof SlotHideContentOpen & keyof SlotHideContentOpenAttributes as `attr:${K}`]?: SlotHideContentOpenAttributes[K] } & { [K in keyof SlotHideContentOpen & keyof SlotHideContentOpenAttributes as `prop:${K}`]?: SlotHideContentOpen[K] };
        "slot-hide-content-scoped": SlotHideContentScoped & { [K in keyof SlotHideContentScoped & keyof SlotHideContentScopedAttributes as `attr:${K}`]?: SlotHideContentScopedAttributes[K] } & { [K in keyof SlotHideContentScoped & keyof SlotHideContentScopedAttributes as `prop:${K}`]?: SlotHideContentScoped[K] };
        "slot-html": SlotHtml & { [K in keyof SlotHtml & keyof SlotHtmlAttributes as `attr:${K}`]?: SlotHtmlAttributes[K] } & { [K in keyof SlotHtml & keyof SlotHtmlAttributes as `prop:${K}`]?: SlotHtml[K] };
        ...
        "slot-nested-default-order-child": SlotNestedDefaultOrderChild & { [K in keyof SlotNestedDefaultOrderChild & keyof SlotNestedDefaultOrderChildAttributes as `attr:${K}`]?: SlotNestedDefaultOrderChildAttributes[K] } & { [K in keyof SlotNestedDefaultOrderChild & keyof SlotNestedDefaultOrderChildAttributes as `prop:${K}`]?: SlotNestedDefaultOrderChild[K] };
        ...
        "slot-none": SlotNone;
        "slot-parent-tag-change": SlotParentTagChange & { [K in keyof SlotParentTagChange & keyof SlotParentTagChangeAttributes as `attr:${K}`]?: SlotParentTagChangeAttributes[K] } & { [K in keyof SlotParentTagChange & keyof SlotParentTagChangeAttributes as `prop:${K}`]?: SlotParentTagChange[K] };
        "slot-parent-tag-change-root": SlotParentTagChangeRoot & { [K in keyof SlotParentTagChangeRoot & keyof SlotParentTagChangeRootAttributes as `attr:${K}`]?: SlotParentTagChangeRootAttributes[K] } & { [K in keyof SlotParentTagChangeRoot & keyof SlotParentTagChangeRootAttributes as `prop:${K}`]?: SlotParentTagChangeRoot[K] };
        "slot-reorder": SlotReorder & { [K in keyof SlotReorder & keyof SlotReorderAttributes as `attr:${K}`]?: SlotReorderAttributes[K] } & { [K in keyof SlotReorder & keyof SlotReorderAttributes as `prop:${K}`]?: SlotReorder[K] };
        "slot-reorder-root": SlotReorderRoot;
        "slot-replace-wrapper": SlotReplaceWrapper & { [K in keyof SlotReplaceWrapper & keyof SlotReplaceWrapperAttributes as `attr:${K}`]?: SlotReplaceWrapperAttributes[K] } & { [K in keyof SlotReplaceWrapper & keyof SlotReplaceWrapperAttributes as `prop:${K}`]?: SlotReplaceWrapper[K] };
        ...
        "ssr-shadow-cmp": SsrShadowCmp & { [K in keyof SsrShadowCmp & keyof SsrShadowCmpAttributes as `attr:${K}`]?: SsrShadowCmpAttributes[K] } & { [K in keyof SsrShadowCmp & keyof SsrShadowCmpAttributes as `prop:${K}`]?: SsrShadowCmp[K] };
        ...
        "ts-target-props": TsTargetProps & { [K in keyof TsTargetProps & keyof TsTargetPropsAttributes as `attr:${K}`]?: TsTargetPropsAttributes[K] } & { [K in keyof TsTargetProps & keyof TsTargetPropsAttributes as `prop:${K}`]?: TsTargetProps[K] };
        "watch-native-attributes": WatchNativeAttributes;
        "watch-native-attributes-no-members": WatchNativeAttributesNoMembers;
        "wrap-ssr-shadow-cmp": WrapSsrShadowCmp & { [K in keyof WrapSsrShadowCmp & keyof WrapSsrShadowCmpAttributes as `attr:${K}`]?: WrapSsrShadowCmpAttributes[K] } & { [K in keyof WrapSsrShadowCmp & keyof WrapSsrShadowCmpAttributes as `prop:${K}`]?: WrapSsrShadowCmp[K] };
    }
}
