...
declare namespace LocalJSX {
    ...
    interface IntrinsicElements {
        ...
        "page-list-item": Omit<PageListItem, keyof PageListItemAttributes> & { [K in keyof PageListItem & keyof PageListItemAttributes]?: PageListItem[K] } & { [K in keyof PageListItem & keyof PageListItemAttributes as `attr:${K}`]?: PageListItemAttributes[K] } & { [K in keyof PageListItem & keyof PageListItemAttributes as `prop:${K}`]?: PageListItem[K] } & OneOf<"label", PageListItem["label"], PageListItemAttributes["label"]>;
