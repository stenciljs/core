...
const maxBundleSize = 21 * 1024 + 64; // 21KB in bytes (non-gzipped - ~8KB gzipped)
...
if (!indexFile) {
  console.error(
    '❌ ERROR: Could not find runtime-HASH.js file in dist/loader-bundle/bundlesize-non-shadow/',
  );
  process.exit(1);
}
