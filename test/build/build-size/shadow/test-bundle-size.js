...
const maxBundleSize = 13 * 1024 + 64; // 13KB in bytes (~12KB non-gzipped, ~5KB gzipped)
...
if (!indexFile) {
  console.error(
    '❌ ERROR: Could not find runtime-HASH.js file in dist/loader-bundle/bundlesize-shadow/',
  );
  process.exit(1);
}
