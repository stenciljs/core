...
export function createJestPuppeteerEnvironment(): JestPuppeteerEnvironmentConstructor {
  const JestEnvironment = class extends NodeEnvironment {
    // Stencil extends Jest's global object with additional properties
    // @ts-expect-error - JestEnvironmentGlobal extends the base Global type with Stencil-specific properties
    override global: JestEnvironmentGlobal;
    browser: any = null;
    pages: any[] = [];
