...
export const STENCIL_INTERNAL_LAZY_CLIENT_PLATFORM_ID = '@stencil/core/runtime/client/lazy';
export const STENCIL_INTERNAL_SSR_PLATFORM_ID = '@stencil/core/runtime/server';
