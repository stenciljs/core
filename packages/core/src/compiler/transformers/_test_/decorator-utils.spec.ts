  ...
  describe('getDecoratorParameters', () => {
    ...
    describe('resolveVar', () => {
      it('should resolve const variable with string literal', () => {
        ...
        const typeCheckerMock = {
          getSymbolAtLocation: vi.fn(() => symbolMock),
          getTypeAtLocation: vi.fn(() => ({
            value: 'myEvent',
            isLiteral: () => true,
          })),
      ...
      it('should resolve object property', () => {
        ...
        const typeCheckerMock = {
          ...
          getTypeOfSymbolAtLocation: vi.fn(() => propertyTypeMock),
        } as unknown as ts.TypeChecker;
      ...
      it('should throw error for non-resolvable variable', () => {
        ...
        const typeCheckerMock = {
          getSymbolAtLocation: vi.fn((): ts.Symbol | undefined => undefined),
        } as unknown as ts.TypeChecker;
      ...
      it('should throw error for non-existent object property', () => {
        ...
        const typeCheckerMock = {
          getTypeAtLocation: vi.fn(() => objectTypeMock),
          getPropertyOfType: vi.fn((): ts.Symbol | undefined => undefined),
        } as unknown as ts.TypeChecker;
