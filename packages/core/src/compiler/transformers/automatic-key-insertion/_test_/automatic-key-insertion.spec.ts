...
describe('automatic key insertion', () => {
  ...
  it('should add a key to one JSX opener', async () => {
    vi.spyOn(keyInsertionUtils, 'deriveJSXKey').mockReturnValue('test-key');
    const t = transpile(`
    @Component({tag: 'cmp-a'})
      export class CmpA {
        render() {
...
`,
  ...
  it('should add a key to a self-closing JSX element', async () => {
    vi.spyOn(keyInsertionUtils, 'deriveJSXKey').mockReturnValue('img-key');
    const t = transpile(`
     @Component({tag: 'cmp-a'})
      export class CmpA {
        render() {
...
`,
  ...
  it('should respect an existing key', async () => {
    vi.spyOn(keyInsertionUtils, 'deriveJSXKey').mockReturnValue('never-key');
    const t = transpile(`
     @Component({tag: 'cmp-a'})
      export class CmpA {
        render() {
...
`,
  ...
  it('should respect an existing key in a loop', async () => {
    vi.spyOn(keyInsertionUtils, 'deriveJSXKey').mockReturnValueOnce('once-key');
    const t = transpile(`
     @Component({tag: 'cmp-a'})
     export class CmpA {
        render() {
...
`,
  ...
  it('should not transform JSX inside of a ternary', async () => {
    vi.spyOn(keyInsertionUtils, 'deriveJSXKey').mockReturnValue('shouldnt-see-key');
    const t = transpile(`
     @Component({tag: 'cmp-a'})
     export class CmpA {
       yes = false;
...
`,
  ...
  it('should not edit a non-stencil class', async () => {
    vi.spyOn(keyInsertionUtils, 'deriveJSXKey').mockReturnValue("shouldn't see this!");
    const t = transpile(`
      export class CmpA {
        render() {
          return <div>hey</div>
