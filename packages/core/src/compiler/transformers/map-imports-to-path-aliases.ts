 ...
 * unknown imports in output code for some output targets (`stencil-rebundle` for instance). Output targets that do not run through a bundler
 ...
 * @param outputTarget The configuration for the stencil-rebundle output target.
