  ...
  !(function (t) {
      ...
      ((u[l] = !0),
        (t.exports =
          ...
          function (t, n) {
            ...
            return (
              null !== t
                ? ((p.prototype = o(t)), (e = new p()), (p.prototype = null), (e[l] = t))
                : (e = v()),
              void 0 === n ? e : i(e, n)
            );
          }));
      ...
      t.exports = h
        ? function (t) {
            ...
            var n = r(this),
              ...
              a = e - 1;
            for (
              arguments.length > 1 && (a = c(a, o(arguments[1]))), a < 0 && (a = e + a);
              a >= 0;
              a--
            )
    ...
    function (t, n, e) {
      ...
      t.exports = function (t, n, e) {
        ...
        return (
          (S[t] = b), r({ global: !0, forced: b != x }, S), h(b, t), d || e.setStrong(b, t, g), b
        );
      };
    },
    function (t, n, e) {
      ...
      var r,
        ...
        Q = function (t, n, e) {
          ...
          (X
            ...
            (o = f['on' + t])
              ? o(r)
              : 'unhandledrejection' === t && j('Unhandled promise rejection', e));
        },
        Z = function (t, n) {
          O.call(f, function () {
            var e,
        ...
        r(
          ...
          function () {
            ...
            return (
              ...
              n +
              '/' +
              String(void 0 === e && t instanceof RegExp && !('flags' in u) ? a.call(t) : e)
            );
          },
          { unsafe: !0 },
        );
        ...
        A = o(
          ...
          function () {
            ...
            return null === r
              ...
              : t.global
                ? ('' == String(r[0]) && (n.lastIndex = d(e, a(n.lastIndex), t.unicode)),
                  { value: r, done: !1 })
        ...
        return [
          ...
          function (t, r) {
            ...
            for (var w, O = '', R = 0, A = 0; A < S.length; A++) {
              E = S[A];
              for (
                var j = String(E[0]), I = l(p(u(E.index), h.length), 0), k = [], P = 1;
                P < E.length;
                P++
              )
            ...
            [
              ...
              function (t, o) {
                ...
                for (var b = 0, S = 0, E = []; S < p.length; ) {
                  ...
                  var w,
                    O = s(x, g ? p : p.slice(S));
                  if (null === O || (w = v(f(x.lastIndex + (g ? 0 : S)), p.length)) === b)
                    S = c(p, S, d);
                  else {
    ...
    function (t, n, e) {
      ...
      var r,
        ...
        J = function (t, n) {
          var e;
          return (
            2 == t.length && A.test(t.charAt(0)) && (':' == (e = t.charAt(1)) || (!n && '|' == e))
          );
        },
        H = function (t) {
          var n;
              ...
              case nt:
                if (a && (j.test(a) || '+' == a || '-' == a || '.' == a)) v += a.toLowerCase();
                  ...
                  if (
                    ...
                    return;
                  if (((t.scheme = v), e))
                    return void (X(t) && V[t.scheme] == t.port && (t.port = null));
                  ((v = ''),
                    'file' == t.scheme
                      ? (s = ht)
              ...
              case ht:
                if (((t.scheme = 'file'), '/' == a || '\\' == a)) s = vt;
                  ...
                  if (a == r) ((t.host = o.host), (t.path = o.path.slice()), (t.query = o.query));
                    ...
                    ((t.host = o.host), (t.path = o.path.slice()), (t.query = ''), (s = mt));
                  else {
                    if ('#' != a) {
                      (H(i.slice(p).join('')) ||
      ...
      var r = e(2),
        ...
        F = function (t, n) {
          if (n)
            for (var e, r, o = n.split('&'), i = 0; i < o.length; )
              (e = o[i++]).length &&
                ((r = e.split('=')), t.push({ key: T(r.shift()), value: T(r.join('=')) }));
        },
        M = function (t) {
        ...
        D = f(
          ...
          function () {
            ...
            return (
              e.done ||
                (e.value = 'keys' === n ? r.key : 'values' === n ? r.value : [r.key, r.value]),
              e
            );
          },
        ),
      ...
      (u(
        B,
        {
          ...
          set: function (t, n) {
            z(arguments.length, 1);
            for (
              var e, r = A(this), o = r.entries, i = !1, a = t + '', u = n + '', c = 0;
              c < o.length;
              c++
            )
...
!(function (t) {
  ...
  function w(t, e) {
    ...
    if (
      ...
      (this.method =
        ((r = e.method || this.method || 'GET'), (o = r.toUpperCase()), m.indexOf(o) > -1 ? o : r)),
