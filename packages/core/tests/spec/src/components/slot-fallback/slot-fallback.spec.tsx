...
describe('slot-fallback', () => {
  it('renders fallback', async () => {
    ...
    expect(document.querySelector('.results1 slot-fb[name="start"]:not([hidden])')!.textContent).toBe(
      'slot start fallback 0',
    );
    expect(document.querySelector('.results1 section slot-fb:not([hidden])')!.textContent).toBe(
      'slot default fallback 0',
    );
    expect(document.querySelector('.results1 article span slot-fb[name="end"]:not([hidden])')!.textContent).toBe(
      'slot end fallback 0',
    );
    ...
    expect(document.querySelector('.results1 content-start')!.textContent).toBe('slot light dom 0 : start');
    expect(document.querySelector('.results1 section content-default')!.textContent).toBe('slot light dom 0 : default');
    expect(document.querySelector('.results1 article span content-end')!.textContent).toBe('slot light dom 0 : end');
    ...
    expect(document.querySelector('.results1 content-start')!.textContent).toBe('slot light dom 1 : start');
    expect(document.querySelector('.results1 section content-default')!.textContent).toBe('slot light dom 1 : default');
    expect(document.querySelector('.results1 article span content-end')!.textContent).toBe('slot light dom 1 : end');
